...
async def faq_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    faq_answers = {
        ...
        "📋 Документы для поездки": (
            ...
            "1. Загранпаспорт (срок действия не менее 6 месяцев)\n\n"
            "2. Виза (для некоторых стран)\n\n"
            "3. Медицинская страховка\n\n"
            "4. Доверенность на выезд детей (если едут без родителей)\n\n"
            "Менеджер @WindowVadim подскажет точный список документов для вашего направления и поможет Вам оформить всё перечисленное"
        ),
        "💳 Оплата и возврат": (
            "💳 *Оплата и возврат*\n\n"
            "1. Предоплата для бронирования тура: 30-50%\n\n"
            "2. Полная оплата за 7-14 дней до вылета\n\n"
            "3. Возврат средств при отказе от тура зависит от условий отеля и авиакомпании\n\n"
            "4. Рекомендуем оформлять страховку от невыезда\n\n"
